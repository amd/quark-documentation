...
.. autoapisummary::
   ...
   quark.onnx.finetuning.create_torch.quant_base_ops.RoundHalfToEven
   quark.onnx.finetuning.create_torch.quant_base_ops.BaseQuantFunction
   quark.onnx.finetuning.create_torch.quant_base_ops.BaseDeQuantFunction
   quark.onnx.finetuning.create_torch.quant_base_ops.BaseQuantDequantFunction
   quark.onnx.finetuning.create_torch.quant_base_ops.INTQuantFunction
   quark.onnx.finetuning.create_torch.quant_base_ops.INTDeQuantFunction
   quark.onnx.finetuning.create_torch.quant_base_ops.INTQuantDequantFunction
   ...
   quark.onnx.finetuning.create_torch.quant_base_ops.QDQModule
...
.. py:class:: BaseQuantFunction(*args, **kwargs)
   ...
   .. py:method:: forward(ctx: Any, tensor: torch.Tensor, scale: torch.Tensor, zero_point: torch.Tensor, min_q: torch.Tensor, max_q: torch.Tensor, round_func: Any) -> torch.Tensor
      :staticmethod:
   ...
   .. py:method:: backward(ctx: Any, grad_output: torch.Tensor) -> Tuple[Optional[torch.Tensor], None, None, None, None, None]
      :staticmethod:
...
.. py:class:: BaseDeQuantFunction(*args, **kwargs)
   ...
   .. py:method:: forward(ctx: torch.autograd.Function, tensor: torch.Tensor, scale: torch.Tensor, zero_point: torch.Tensor) -> torch.Tensor
      :staticmethod:
   ...
   .. py:method:: backward(ctx: torch.autograd.Function, grad_output: torch.Tensor) -> Tuple[torch.Tensor, None, None]
      :staticmethod:
...
.. py:class:: BaseQuantDequantFunction(*args, **kwargs)
   ...
   .. py:method:: backward(ctx: Any, grad_output: torch.Tensor) -> Tuple[torch.Tensor, None, None, None, None, None]
      :staticmethod:
...
.. py:class:: QDQModule(scale: torch.Tensor, zero_point: torch.Tensor, min_q: torch.Tensor, max_q: torch.Tensor, ch_axis: int = 0, q_folded: bool = False)




   A pytorch module that behaves as ONNX's QDQ pair
