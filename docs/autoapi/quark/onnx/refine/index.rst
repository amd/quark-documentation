...
.. py:function:: align_quantize_info(model: onnx.ModelProto, max_loop_num: int = 5, align_concat: bool = True, align_pool: bool = True, align_pad: bool = True, align_slice: bool = True, align_transpose: bool = True, align_reshape: bool = True) -> Any
