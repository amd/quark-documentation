...
:py:mod:`quark.torch.quantization.graph.optimization.replace_conv_bn_to_qt_model`
=================================================================================

.. py:module:: quark.torch.quantization.graph.optimization.replace_conv_bn_to_qt_model
...
.. autoapisummary::
   ...
   quark.torch.quantization.graph.optimization.replace_conv_bn_to_qt_model.replace_conv2dbn_quantizedconv_module



.. py:function:: replace_conv2dbn_quantizedconv_module(m: torch.fx.GraphModule) -> None
