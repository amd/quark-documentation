...
.. py:class:: BaseAlgoProcessor(q_model: quark.torch.algorithm.models.base.BaseQuantModelForCausalLM, model: transformers.PreTrainedModel, quant_algo_config: Any, calib_data: Union[torch.utils.data.DataLoader[torch.Tensor], torch.utils.data.DataLoader[List[Dict[str, torch.Tensor]]], torch.utils.data.DataLoader[Dict[str, torch.Tensor]]])
