...
.. WARNING: The AutoAPI `.. toctree::` entry is defined at docs/source/autoapi_index.rst
..          and post-processed by a Sphinx extension at `docs/source/_ext/quark_autoapi_build.py`
..          to not break QUARK_SPHINX_BUILD_SKIP_AUTOAPI=1 behavior due to warnings generated by pages not included in any toctree
@quark_autoapi_toc_placeholder@
