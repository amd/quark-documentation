...
.. WARNING: The AutoAPI `.. toctree::` entry is defined by a Sphinx extension at `docs/source/_ext/quark_autoapi_build.py`
..          to not break QUARK_SKIP_DOC_AUTOAPI=1 behavior due to warnings generated by pages not included in any toctree
