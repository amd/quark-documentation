...
but also support exporting in popular formats requested by downstream tools, including `ONNX`, `Format for HuggingFace&vLLM (HF format)`, and `GGUF`.
...
.. toctree::
   ...
   HuggingFace Format <quark_export_hf.rst>
