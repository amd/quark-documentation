...
**Step 1**: Download and unzip 📥quark.zip and there is a whl package in it. Or you can download whl package 📥quark.whl directly.
   ...
   `📥quark.zip release_version (recommend) <https://www.xilinx.com/bin/public/openDownload?filename=quark-0.2.0+6af1bac23.zip>`__

   `📥quark.whl release_version <https://www.xilinx.com/bin/public/openDownload?filename=quark-0.2.0+6af1bac23-py3-none-any.whl/>`__
